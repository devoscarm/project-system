...
- Short term — the checklist of what to do next over the coming sessions: concrete, decided actions. Any decision that gets made lands here (or in Long term). Rewritten each session, never appended.
...
## Now
_(placeholder — replace on first fill)_
